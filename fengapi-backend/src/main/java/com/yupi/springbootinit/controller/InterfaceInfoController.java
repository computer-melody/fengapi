...
import com.yupi.springbootinit.model.enums.InterfaceInfoStausEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        String username = fengApiClinet.getUsernameByPost(user);
        ...
        interfaceInfo.setStatus(InterfaceInfoStausEnum.ONLINE.getValue());
        boolean result = interfaceInfoService.updateById(interfaceInfo);
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Boolean> offlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        InterfaceInfo interfaceInfo = new InterfaceInfo();
        interfaceInfo.setId(id);
        interfaceInfo.setStatus(InterfaceInfoStausEnum.OFFLINE.getValue());
        boolean result = interfaceInfoService.updateById(interfaceInfo);
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        if (oldInterfaceInfo.getStatus() != InterfaceInfoStausEnum.ONLINE.getValue()){
        ...
        FengApiClinet tempApiClinet = new FengApiClinet(accessKey, secretKey);
        Gson gson = new Gson();
        User user = gson.fromJson(userRequestParams, User.class);
        String usernameByPost = tempApiClinet.getUsernameByPost(user);
